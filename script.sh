...
# mirrors
aurman --needed --noconfirm --noedit --skip_news -Syu reflector
...
# xorg + gnome
aurman --needed --noconfirm --noedit --skip_news -Syu xorg-server gnome gdm networkmanager file-roller unrar plank gnome-tweaks
...
# nvidia
aurman --needed --noconfirm --noedit --skip_news -Syu nvidia-dkms lib32-nvidia-utils dkms linux-headers nvidia-settings

# intel
aurman --needed --noconfirm --noedit --skip_news -Syu mesa lib32-mesa xf86-video-intel
...
aurman --needed --noconfirm --noedit --skip_news -Syu libinput xf86-input-libinput xorg-xinput
...
aurman --needed --noconfirm --noedit --skip_news -Syu git networkmanager-openvpn
...
# ufw
aurman --needed --noconfirm --noedit --skip_news -Syu ufw
...
# ssh
aurman --needed --noconfirm --noedit --skip_news -Syu wget openssh
...
sudo pacman -Syy
aurman --needed --noconfirm --noedit --skip_news -Syu sublime-text
...
# themes
aurman --needed --noconfirm --noedit --skip_news -Syu paper-icon-theme-git arc-gtk-theme
