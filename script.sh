...
# makepkg
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu ccache
...
# mirrors
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu reflector
...
# xorg + gnome
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu xorg-server gnome gdm networkmanager file-roller unrar plank gnome-tweaks
...
# nvidia
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu nvidia-dkms lib32-nvidia-utils dkms linux-headers nvidia-settings

# intel
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu mesa lib32-mesa xf86-video-intel
...
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu libinput xf86-input-libinput xorg-xinput
...
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu git networkmanager-openvpn
...
# ufw
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu ufw
...
# ssh
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu wget openssh
...
sudo pacman -Syy
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu sublime-text
...
# themes
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu paper-icon-theme-git arc-gtk-theme
...
# signal
aurman --needed --noconfirm --noedit --skip_news --pgp_fetch -Syu signal-desktop-bin
