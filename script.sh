...
# makepkg
aurman --needed --noconfirm --noedit -Syu --pk ccache
...
# mirrors
aurman --needed --noconfirm --noedit -Syu --pk reflector
...
# xorg + gnome
aurman --needed --noconfirm --noedit -Syu --pk xorg-server gnome gdm networkmanager file-roller unrar plank gnome-tweak-tool
...
# nvidia
aurman --needed --noconfirm --noedit -Syu --pk nvidia-dkms lib32-nvidia-utils dkms linux-headers nvidia-settings

# intel
aurman --needed --noconfirm --noedit -Syu --pk mesa lib32-mesa xf86-video-intel
...
aurman --needed --noconfirm --noedit -Syu --pk libinput xf86-input-libinput xorg-xinput
...
aurman --needed --noconfirm --noedit -Syu --pk git networkmanager-openvpn
...
# ufw
aurman --needed --noconfirm --noedit -Syu --pk ufw
...
# ssh
aurman --needed --noconfirm --noedit -Syu --pk wget openssh
...
sudo pacman -Syy
aurman --needed --noconfirm --noedit -Syu --pk sublime-text
...
# themes
aurman --needed --noconfirm --noedit -Syu --pk paper-icon-theme-git arc-gtk-theme
...
# signal
aurman --needed --noconfirm --noedit -Syu --pk signal-desktop-bin
